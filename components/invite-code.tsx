...
export default function InviteCode () {
    return (
        <div className="flex flex-col items-center justify-normal max-w-md gap-y-8 p-8 rounded-3xl bg-opacity-50 backdrop-blur-lg bg-background" data-aos="fade-up" data-aos-delay="500">
