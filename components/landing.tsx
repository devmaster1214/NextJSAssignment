    ...
    <section className="relative bg-background">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 pointer-events-none -z-1" aria-hidden="true">
        <svg xmlns="http://www.w3.org/2000/svg" width="100vw" height="100vh" viewBox="0 0 1440 779" fill="none">
          ...
          <defs>
            <filter id="filter0_f_4775_12747" x="-735" y="0" width="3010" height="1209" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
          ...
          <div className="text-center pb-24 md:pb-32">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none" data-aos="zoom-y-out" data-aos-delay="300">
                <a className="btn text-white bg-primary hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0 uppercase" href="#0">Join Early Access</a>
              </div>
            </div>
          </div>
