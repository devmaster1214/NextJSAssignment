    ...
    return (
        <section className="relative bg-background">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                { /*  */ }
                <div className="flex flex-col justify-center items-center gap-x-16 lg:flex-row gap-y-16 pt-24">
                    <div className="flex flex-1 px-8" data-aos="zoom-in">
                        <img src="/images/techring.png" className="w-full"/>
                    </div>
                    <div className="flex-1" data-aos="fade-left" data-aos-delay="500">
                        <h2 className="w-full text-center md:text-start text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none pb-8">Build with yield</h2>
                ...
                <div className="flex flex-col items-start gap-y-16 pt-20">
                    <h2 className="w-full text-center md:text-start text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none" data-aos="fade-up">An evm-compatible L2 designed to help you and your users earn more.</h2>
                    <div className="w-full flex flex-col lg:flex-row gap-4 items-start">
                        <div className="flex-1" data-aos="fade-right">
                            <div className="flex flex-row items-center gap-4 pb-4">
                                <img src="/images/eth.png" className="w-16"/>
                ...
                <div className="flex flex-col items-start gap-y-8 pt-20">
                    <h2 className="w-full text-center md:text-start text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none" data-aos="fade-up">If you've deployed on mainnet or any L2, you can easily deploy on Blast.</h2>
                    ...
                    <div className="w-full flex flex-col items-center" data-aos="fade-up">
                        { seleted == 0
                            ? <img src="/images/code-1.png" alt="Developer code 1" className="rounded-2xl"/>
                            : seleted == 1
                                ? <img src="/images/code-2.png" alt="Developer code 2" className="rounded-2xl"/>
                                : <img src="/images/code-3.png" alt="Developer code 3" className="rounded-2xl"/>
                        }
                    </div>
                    ...
                    <div className="w-full flex flex-row justify-center items-center gap-8" data-aos="fade-up">
                        <img src="/images/letterhead/letterhead-hardhat.webp" alt="Hardhat"/>
                        <img src="/images/letterhead/letterhead-foundry.webp" alt="foundry"/>
                    </div>
                </div>

                { /*  */ }
                <div className="flex flex-col items-start gap-y-8 pt-20">
                    <h2 className="w-full text-center md:text-start text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none" data-aos="fade-up">Why a new Next.js?</h2>
                ...
                {/*  */}
                <div className="pt-20">
                    <h2 className="w-full text-center md:text-start text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none pb-8" data-aos="fade-up">It's time to ditch other L2s</h2>
                    ...
                    <img src="/images/blast-l2-comparison_en.webp" alt="Blast L2 Comparison" className="w-full pb-16" data-aos="zoom-out"/>
                </div>
                ...
                <div className="flex flex-col items-start gap-y-16 pt-20">
                    <div className="w-full flex flex-col gap-16 items-start">
                        <div className="flex flex-col lg:flex-row items-center justify-stretch gap-8" data-aos="fade-right">
                            ...
                            <div className="pl-4">
                                <h3 className="w-full text-center md:text-start text-3xl text-primary font-medium leading-tight pb-8">$938M LIQUIDITY WAITING FOR YOU</h3>
                                <p className="text-3xl text-secondary font-medium leading-tight">82,669 users have deposited $938M to Blast in anticipation of the mainnet launch in February. When the Blast mainnet launches, the bridge contract will unlock and release all those users and funds to your dapps.</p>
                            </div>
                        </div>
                        <div className="flex flex-col lg:flex-row items-center justify-stretch gap-8" data-aos="fade-right">
                            <div className="flex flex-row lg:flex-col items-center gap-8 min-w-[320px]">
                            ...
                            <div className="pl-4">
                                <h3 className="w-full text-center md:text-start text-3xl text-primary font-medium leading-tight pb-8">BLAST DEVELOPER AIRDROP</h3>
                                <p className="text-3xl text-secondary font-medium leading-tight">The Blast Developer Airdrop goes live in January, when the Blast Testnet launches. 50% of the Blast airdrop has been allocated for developers. Instructions on how to claim the airdrop and how it works will be shared upon testnet launch.</p>
                            </div>
                        </div>
                        <img src="/images/blast-timeline-devs.webp" alt="Blast timeline devs" className="w-full pb-16" data-aos="zoom-out"/>
                        <div className="flex flex-col lg:flex-row items-center justify-stretch gap-8" data-aos="fade-right">
                            <div className="flex flex-row lg:flex-col items-center gap-8 min-w-[320px]">
                                <img src="/images/illustration-community.webp" alt="Illustration-community"/>
                            </div>  
                            <div className="pl-4 w-full text-center md:text-start ">
                                <h3 className="text-3xl text-primary font-medium leading-tight pb-8">JOIN THE COMMUNITY</h3>
                                <p className="text-3xl text-secondary font-medium leading-tight pb-8">In the meantime, join our developer community on Discord to learn more about Blast (also so you don't miss the airdrop).</p>
