            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="flex flex-col justify-center items-center gap-x-16 lg:flex-row gap-y-16 pt-24">
                    <div className="flex flex-1 px-8" data-aos="zoom-in">
                        <img src="/images/nextjs.png" className="w-full"/>
                    </div>
                    <div className="flex-1" data-aos="fade-left" data-aos-delay="500">
                        <h2 className="text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none pb-8 text-center md:text-start">Next.js helps you to build best website</h2>
                        ...
                        <p className="text-xl lg:text-3xl text-secondary font-semibold leading-tight pb-8 uppercase text-center">Backed by</p>
                        <div className="flex flex-row gap-x-16 justify-center">
                            <img src="/images/node-logo.png" alt="NextJS" className="h-16"/>
                            <img src="/images/tailwind-logo.png" alt="TailwindCSS" className="h-16"/>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-start gap-y-8 pt-20">
                    <h2 className="text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none text-center md:text-start" data-aos="fade-up">The major difference between Next JS and React JS is performance.</h2>
                    ...
                    <div className="w-full flex flex-col items-center px-8" data-aos="zoom-in-up">
                        <img src="/images/nextvsreact.webp"/>
                    </div>
                </div>
                
                { /* How Next.js work content */ }
                <div className="flex flex-col items-start gap-y-16 pt-20">
                    <h2 className="w-full text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none text-center md:text-start" data-aos="fade-up">How Next.js work?</h2>
                    <div className="w-full flex flex-col lg:flex-row gap-4 items-start">
                        <div className="flex-1" data-aos="fade-right">
                            <div className="flex flex-row items-center gap-4 pb-4">
                                <img src="/images/vite-logo.png" className="w-16"/>
                ...
                <div className="flex flex-col items-start gap-y-8 pt-20">
                    <h2 className="w-full text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none text-center md:text-start" data-aos="fade-up">Why a new Next.js?</h2>
                ...
                { /* Who we are */ }
                <div className="flex flex-col items-start gap-y-16 pt-20">
                    <h2 className="w-full text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none text-center md:text-start" data-aos="fade-up">Who we are</h2>
                    <div className="w-full flex flex-col gap-16 items-start">
                        <div className="flex flex-col lg:flex-row items-center justify-stretch gap-8" data-aos="fade-right">
                            <div className="flex flex-row lg:flex-col items-center gap-8 min-w-[400px]">
                                <img src="/images/letterhead/letterhead-pacman.webp" alt="Pacman" className="h-10 w-auto"/>
                                <img src="/images/letterhead/letterhead-blur.webp" alt="Blur" className="h-10 w-auto"/>
                            </div>
                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-stretch gap-8" data-aos="fade-left">
                            <div className="flex flex-row lg:flex-col flex-wrap justify-center items-center gap-8 min-w-[400px]">
                                <img src="/images/letterhead/letterhead-mit.webp" alt="Mit" className="h-10 w-auto"/>
                                <img src="/images/letterhead/letterhead-ntu.webp" alt="Ntu" className="h-10 w-auto"/>
                                <img src="/images/letterhead/letterhead-snu.webp" alt="Snu" className="h-10 w-auto"/>
                                <img src="/images/letterhead/letterhead-yc.webp" alt="Yc " className="h-10 w-auto"/>
                                <img src="/images/letterhead/letterhead-makerdao.webp" alt="Makerdao" className="h-10 w-auto"/>
                            </div>
                            <div className="self-stretch hidden lg:block lg:w-1.5 lg:h-auto bg-primary"></div>
                            <div className="border-primary">
                                <p className="text-xl text-primary font-medium leading-tight pl-4">Our Next.js project migrated on Vite so improved speed and efficiency. Vite uses a faster build process and a unique approach to code splitting, which results in faster build times and faster load times for the end-user.</p>
                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-stretch gap-8" data-aos="fade-right">
                            <div className="flex flex-row lg:flex-col items-center gap-8 min-w-[400px]">
                                <img src="/images/letterhead/letterhead-paradigm.webp" alt="paradigm" className="h-10 w-auto"/>
                                <img src="/images/letterhead/letterhead-standard-crypto.webp" alt="Standard-crypto" className="h-10 w-auto"/>
                            </div>
                            <div className="self-stretch hidden lg:block lg:w-1.5 lg:h-auto bg-primary"></div>
                            <div className="border-primary">
                                <p className="text-xl text-primary font-medium leading-tight pl-4">Our Next.js project migrated on Vite so improved speed and efficiency. Vite uses a faster build process and a unique approach to code splitting, which results in faster build times and faster load times for the end-user.</p>
                ...
                {/* Airdrop timeline */}
                <div className="pt-20">
                    <h2 className="w-full text-4xl lg:text-5xl text-primary font-bold leading-tight tracking-none pb-8 text-center md:text-start" data-aos="fade-up">Airdrop timeline</h2>
                    ...
                    <img src="/images/blast-timeline-about.webp" className="w-full pb-16" data-aos="zoom-out"/>
                ...
                {/* Go to airdrop */}
                <div className="w-full flex flex-col items-center pt-20 pb-32 text-center md:text-start" data-aos="zoom-in-down">
